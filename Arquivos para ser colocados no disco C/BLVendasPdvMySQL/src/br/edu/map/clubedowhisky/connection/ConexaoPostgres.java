package br.edu.map.clubedowhisky.connection;
...
public class ConexaoPostgres {
    ...
    private String nomeDoBanco = "clubedowhisky";
    private String usuario = "postgres";
    private String senha = "admin";
    
    public ConexaoPostgres(){}
    
    public ConexaoPostgres(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
