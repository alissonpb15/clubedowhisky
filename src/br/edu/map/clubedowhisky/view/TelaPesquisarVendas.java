 ...
 */
public class TelaPesquisarVendas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Iccone pesqusar 16 x 16.png"))); // NOI18N
        ...
        if (tbConsultasVendas.getColumnModel().getColumnCount() > 0) {
            ...
            tbConsultasVendas.getColumnModel().getColumn(1).setPreferredWidth(430);
        }
        ...
        if (tfDesconto.getText().equals("") || tfValorTotal.getText().equals("") || tbProdutos.getRowCount() < 1) {
            ...
            for (int i = 0; i < tbProdutos.getRowCount(); i++) {
                ...
                try {
                    ...
                    Logger.getLogger(TelaPesquisarVendas.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisarVendas().setVisible(true);
            }
        });
    }
